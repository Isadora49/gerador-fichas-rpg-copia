...
document.getElementById('btnDownload').addEventListener('click', async () => {
    try {
        ...
        const scriptMotor = [
            ...
            '  if (nivel >= 51) return "1d100"; if (nivel <= 50) return "1d50";',
            ...
            'var d1N = (n1 >= 51)?100:(n1 <= 50)?50:(n1 <= 35)?20:(n1 <= 25)?12:(n1 <= 20)?10:(n1 <= 15)?8:(n1 <= 10)?6:(n1 <= 5)?4;',
            ...
            'var d2N = (n2 >= 51)?100:(n2 <= 50)?50:(n2 <= 35)?20:(n2 <= 25)?12:(n2 <= 20)?10:(n2 <= 15)?8:(n2 <= 10)?6:(n2 <= 5)?4;',
